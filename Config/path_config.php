...
define('MODELS_PATH', ROOT.DS.'Models');//Path for models
define('VIEWS_PATH', ROOT.DS.'Views');//Path for views
define('CONTROLLERS_PATH', ROOT.DS.'Controllers');//Path for controllers
...
define('UPLOAD_PATH', ROOT.DS.'Uploads');
